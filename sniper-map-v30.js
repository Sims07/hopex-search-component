(function() {
    ...
    const v30Code = "javascript:(" + function() {
        ...
        styleElement.innerHTML = '.' + W + ', .' + A + ' { pointer-events: none !important; }' +
        ...
        p.className = P + ' r-pn';
        p.innerHTML = '<div class="r-drg" style="font-weight:bold; color:#0C419A; margin-bottom:8px; font-size:12px; display:flex; justify-content:space-between; border-bottom:1px solid #E7ECF5; padding-bottom:4px;">' +
        ...
        function runFilters() {
            ...
            if (count > 0) {
                ...
                activeFilters.forEach(a => {
                    ...
                    if (items.length > 0) {
                        htmlGrid += '<div class="r-cd" style="border-top:4px solid ' + a.c + '">' +
